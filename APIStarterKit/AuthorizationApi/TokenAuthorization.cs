...
//Token Authorization contains a series of methods used by the methods in the UserController to serialize, encrypt, deserialize, and decrypt user tokens.
namespace APIStarterKit.APIStarterKit
{
